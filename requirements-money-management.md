...
- REQ-M010: The plugin shall provide a command to undo the most recently logged transaction within the current session.
...
- REQ-M027: For the selected period, the system shall display total balance, income, expenses, and net.
- REQ-M028: The system shall display a chart of income vs. expenses over the selected period.
- REQ-M029: The system shall display a net-worth-over-time chart with a selectable trailing window (e.g. 3/6/12/24 months), always including a zero baseline.
...
- This module will NOT handle multi-currency conversion/exchange rates in this phase — accounts have a currency field, but cross-currency totals/conversion are out of scope unless requested later.
